...
Performance_blocking0.txt: Performance_blocking0.x   		#Se ejecuta el archivo Performance_blocking0.x según el tamaño de matriz y operaciones deseadas (multiplicación y #transposición)
	./$< $(M_S) $(T_M) $(CUENT) > datafiles/$(M_S)_$(T_M)_$(CUENT)_$@		
...
Performance_Matrix_Size0.txt: Performance_Matrix_Size0.x   	#Se ejecuta el archivo Performance_Matrix_Size0.txt según la operación deseada (multiplicación por armadillo y eigen, transposición por armadillo y eigen)
	./$< $(T_M) $(CUENT) > datafiles/$(T_M)_$(CUENT)_$@				
...
block_all.pdf: Performance_blocking0.txt Performance_blocking3.txt  
	mv datafiles/$(M_S)_$(T_M)_$(CUENT)_Performance_blocking0.txt aux0.txt        
	mv datafiles/$(M_S)_$(T_M)_$(CUENT)_Performance_blocking3.txt aux3.txt         
	gnuplot plot_block.gp
	mv file1.pdf pdffiles/blocking_$(M_S)_$(T_M)_$(CUENT)_Mflops.pdf				 
	mv file2.pdf pdffiles/blocking_$(M_S)_$(T_M)_$(CUENT)_Time.pdf				
	mv  aux0.txt datafiles/$(M_S)_$(T_M)_$(CUENT)_Performance_blocking0.txt
	mv  aux3.txt datafiles/$(M_S)_$(T_M)_$(CUENT)_Performance_blocking3.txt 
block.pdf: datafiles/$(M_S)_$(T_M)_$(CUENT)_Performance_blocking0.txt datafiles/$(M_S)_$(T_M)_$(CUENT)_Performance_blocking3.txt #grafica si el archivo .txt deseado ya existe
	mv datafiles/$(M_S)_$(T_M)_$(CUENT)_Performance_blocking0.txt aux0.txt        
	mv datafiles/$(M_S)_$(T_M)_$(CUENT)_Performance_blocking3.txt aux3.txt         
	gnuplot plot_block.gp
	mv file1.pdf pdffiles/blocking_$(M_S)_$(T_M)_$(CUENT)_Mflops.pdf
...
size_all.pdf: Performance_Matrix_Size0.txt Performance_Matrix_Size3.txt 	
	mv datafiles/$(T_M)_$(CUENT)_Performance_Matrix_Size0.txt aux0.txt			
	mv datafiles/$(T_M)_$(CUENT)_Performance_Matrix_Size3.txt aux3.txt
	gnuplot plot_matrix.gp
	mv file1.pdf pdffiles/Matrix_$(T_M)_$(CUENT)_Mflops.pdf				
	mv file2.pdf pdffiles/Matrix_$(T_M)_$(CUENT)_Time.pdf				
	mv aux0.txt datafiles/$(T_M)_$(CUENT)_Performance_Matrix_Size0.txt
	mv aux3.txt datafiles/$(T_M)_$(CUENT)_Performance_Matrix_Size3.txt

Msize.pdf: datafiles/$(T_M)_$(CUENT)_Performance_Matrix_Size0.txt datafiles/$(T_M)_$(CUENT)_Performance_Matrix_Size3.txt #grafica si ya existen los archivos .txt
	mv datafiles/$(T_M)_$(CUENT)_Performance_Matrix_Size0.txt aux0.txt
	mv datafiles/$(T_M)_$(CUENT)_Performance_Matrix_Size3.txt aux3.txt
	gnuplot plot_matrix.gp
	mv file1.pdf pdffiles/Matrix_$(T_M)_$(CUENT)_Mflops.pdf				
	...
	mv aux0.txt datafiles/$(T_M)_$(CUENT)_Performance_Matrix_Size0.txt
	mv aux3.txt datafiles/$(T_M)_$(CUENT)_Performance_Matrix_Size3.txt
allGraphs.pdf: plot_all_block.pg
	gnuplot plot_all_block.pg
